...
TTourStopOwnerSimpleProcessForm *TourStopOwnerSimpleProcessForm;

//---------------------------------------------------------------------------
__fastcall TTourStopOwnerSimpleProcessForm::TTourStopOwnerSimpleProcessForm(TComponent* Owner)
        : TTourSimpleProcessForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TTourStopOwnerSimpleProcessForm::FormCloseQuery(TObject *Sender,
      bool &CanClose)
 {
  bool                                 NoErrorFlag;
    ...
    if (NoErrorFlag)
     {
      if (StopOwnerEdit->Text.IsEmpty())
       {
        ErrorMessageStr
        = GetTranslatedStr(TourStopOwnerSimpleProcessStopOwnerFieldEmptyErrorMessageStr);
        ExceptionMessageStr
        = GetTranslatedStr(TourStopOwnerSimpleProcessStopOwnerFieldEmptyExceptionMessageStr);
        NoErrorFlag = false;
