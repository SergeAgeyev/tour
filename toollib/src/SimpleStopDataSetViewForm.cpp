...
#pragma resource "*.dfm"
TTourSimpleStopDataSetViewForm *TourSimpleStopDataSetViewForm;

#define  GetTranslatedStr(Index)  VStringStorage->Lines->Strings[Index]

//---------------------------------------------------------------------------
__fastcall TTourSimpleStopDataSetViewForm::TTourSimpleStopDataSetViewForm(TComponent* Owner)
        : TTourSimpleDataSetViewForm(Owner)
 {
  ColumnToSort = 2;
 }
//---------------------------------------------------------------------------
void __fastcall TTourSimpleStopDataSetViewForm::ListViewColumnClick(
...
void __fastcall TTourSimpleStopDataSetViewForm::ListViewCompare(
...
void __fastcall TTourSimpleStopDataSetViewForm::FormCloseQuery(
...
void __fastcall TTourSimpleStopDataSetViewForm::PanelResize(
      TObject *Sender)
 {
